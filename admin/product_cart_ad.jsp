...
<body>
	...
	<div class="row">
		<table width="100%">
			<tr>
				<td align="left"><a href="product_cart_remove_all_ad.jsp?cartId=<%=cartId%>" class="btn btn-danger">삭제하기</a></td>
	...
	<div style="padding-top: 50px">
		<table class="table table-hover">
			...
			<tr>
				...
				<td><%=total%></td>
				<td><a href="product_cart_remove_ad.jsp?id=<%=product.getProductId()%>" class="badge badge-danger">삭제</a></td>
			</tr>
			<%
				}
			%>
